...
const Hero = () => {
  ...
  <div className="h-screen flex items-center justify-center" id="hero">
    <div className="relative z-10 text-center w-1/2 max-md:w-11/12 text-white">
    <h1 className="text-5xl font-bold max-md:text-4xl text-[#d2643d] mb-10">وايت قاردن</h1>
