    ...
    return (
        <div className="w-10/12 mx-auto pb-40 text-center opacity-0 translate-y-10 duration-500" id="branches">
          ...
          <div className="grid mt-20 grid-cols-3 gap-5 max-lg:grid-cols-2 max-md:grid-cols-1">
            ...
            <a href="https://goo.gl/maps/FkDmu1UKjDdHTAKc7"  target="_blank" className="branch shadow-xl opacity-0 translate-y-10 duration-500 delay-700 h-96">
            ...
            <a href="https://goo.gl/maps/AVJcAHhv4KoSoTXV7" target="_blank" className="branch shadow-xl opacity-0 translate-y-10 duration-500 delay-1000 h-96">
            ...
            <a href="https://goo.gl/maps/EiwLP2jqKVk3nq8t8" target="_blank" className="branch shadow-xl opacity-0 translate-y-10 duration-500 delay-[1.3s] h-96">
